                                ...
                                <div class="wsus__login">
                                    <form action="{{ route('store-register') }}" method="POST">
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            <input type="text" placeholder="{{__('user.Email')}}" name="email" required>
                                        </div>
                                        <div class="wsus__login_input">
                                            <i class="fas fa-key"></i>
                                        ...
                                        <div class="wsus__login_input">
                                            <i class="fas fa-key"></i>
                                            <input type="password" placeholder="{{__('user.Confirm Password')}}" name="password_confirmation" required>
                                        </div>
                                        <div class="wsus__login_save">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault03" name="agree" required>
