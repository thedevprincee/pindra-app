        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{__('admin.Create Course')}}</div>
            </div>
          </div>

          <div class="section-body">
            <a href="{{ route('admin.course.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('admin.Course')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
