...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          @if (($logedInAdmin->admin_type == 2) || ($logedInAdmin->admin_type >= 3))
          ...
          @if (($logedInAdmin->admin_type == 2) || ($logedInAdmin->admin_type >= 3))
          <li class="nav-item dropdown {{ Route::is('admin.course.*') || Route::is('admin.course.create') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('admin.Manage Course')}}</span></a>
            <ul class="dropdown-menu">

              <li class="{{ Route::is('admin.course.create') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.course.create') }}">{{__('admin.Create Course')}}</a>
              </li>

              <li class="{{ Route::is('admin.course.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.course.index') }}">{{__('admin.Course')}}</a>
              </li>

            </ul>
          </li>
          <li class="nav-item dropdown {{ Route::is('admin.microcourse.*') || Route::is('admin.microcourse.create') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('admin.Micro Course')}}</span></a>
            <ul class="dropdown-menu">

              <li class="{{ Route::is('admin.microcourse.create') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.product.create') }}">{{__('admin.Create Micro Course')}}</a>
              </li>

              <li class="{{ Route::is('admin.microcourse.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.microcourse.index') }}">{{__('admin.Micro Course')}}</a>
              </li>
          ...
          @if (($logedInAdmin->admin_type == 1) || ($logedInAdmin->admin_type >= 3))
