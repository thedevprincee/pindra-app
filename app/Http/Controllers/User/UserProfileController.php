...
class UserProfileController extends Controller
{
    ...
    public function dashboard(){
        ...
        return view('user.dashboard', compact('orders','reviews','wishlists', 'defaultProfile'));
    }
    ...
    public function myProfile(){
        ...
        $defaultProfile = BannerImage::whereId('15')->first();
        return view('user.my_profile', compact('user','countries','defaultProfile'));
    }
    ...
    public function updateProfile(Request $request){
        ...
        $customMessages = [
            ...
            'username.unique' => trans('user_validation.Username already exist'),
    ...
    public function updateProfilePix(Request $request){
        ...
        $customMessages = [
            'name.required' => trans('user_validation.Image is required')
        ];
        ...
        $notification = trans('user_validation.Image Uploaded Successfully');
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->back()->with($notification);
    }
