...
class CourseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.course',compact('products','orderProducts','setting'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.create_course',compact('categories','brands','productTaxs','retrunPolicies','specificationKeys'));
    }
