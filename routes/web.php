...
use App\Http\Controllers\Admin\MicroCourseController;
...
Route::group(['middleware' => ['maintainance']], function () {
    ...
    Route::group(['as'=> 'user.', 'prefix' => 'user'],function (){
        ...
        Route::post('update-profile-pix', [UserProfileController::class, 'updateProfilePix'])->name('update-profile-pix');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
  ...
  //  Route::put('product-tax-status/{id}', [ProductTaxController::class,'changeStatus'])->name('product.tax.status');
    ...
    Route::put('course-status/{id}', [CourseController::class,'changeStatus'])->name('course.status');
    ...
    Route::resource('microcourse', MicroCourseController::class);
